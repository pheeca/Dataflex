...
var DomOutline = function (options) {
    ...
    var self = {
        opts: {
            ...
            compileLabelText:options.compileLabelText||(()=>'')
        },
        keyCodes: {
            BACKSPACE: 8,
            ESC: 27,
    ...
    function updateOutlinePosition(e) {
        if (typeof(e.target.className)!=='object' && (e.target.className||'').indexOf(self.opts.namespace) !== -1) {
            return;
        }
        if (self.opts.filter) {
        ...
        var label_text = self.opts.compileLabelText(pub.element, pos.width, pos.height);
